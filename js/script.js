...
function generateAuthors() {
  ...
  for (let author in allAuthors){
    ...
    const authorClass = calculateAuthorsClass(allAuthors[author], authorParams);
    allAuthorsHTML += '<li><a class="' + authorClass + '" href="#author-' + author + '">' + author + '</a></li>';
